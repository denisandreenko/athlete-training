...
FATIGUE_SCORE: 1 (fresh) – 5 (very tired)
SLEEP_SCORE: 1 (poor) – 5 (excellent)
...
- sleep: ?
- rpe: ?
- notes: Auto-synced from Strava: "Zwift - Taper Time" · 25.7km · 313m gain · avg HR 129 · max HR 146

### Endurance
- duration: 50min
- avg_power_or_pace: 206W
- terrain: trainer
...
- sleep: 4/5
- rpe: 7/10
- notes: First log entry. Hack squat felt stable, no sacral issues. Bench solid.

### Key lifts
| Exercise | Sets×Reps | Load (kg) | Notes |
|---|---|---|---|
| Hack squat | 3×8 | 75 | RPE 7, felt controlled |
| Bench press | 3×6 | 77.5 | last set hard |
| Single-leg hip thrust | 3×12 | BW | week 1, bodyweight only |
| Chin-ups | 3×8 | BW | clean reps |
...
- sleep: 4/5
- rpe: 7/10
- notes: Weighted pull-ups felt strong. OHP shoulder stable.

### Key lifts
| Exercise | Sets×Reps | Load (kg) | Notes |
|---|---|---|---|
| Weighted pull-ups | 3×6 | +20 | RPE 7 |
| Chest-supported row | 3×10 | 60 | good mind-muscle |
| Seated DB OHP | 2×10 | 20 | shoulder fine |
| Ab wheel rollout | 2×10 | BW | controlled |
